aperr_sf <- function(x, y)
{
    ...
    #
    # Output
    # Absolute percentage error (APE). It is negatively oriented and 0 <= APE.
    # The lower its value, the better the median functional forecast.
    # Each value of the output is the APE corresponding to the respective value
    # of the vectors x, y.
    #
    # References
