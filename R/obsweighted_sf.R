obsweighted_sf <- function(x, y)
{
    ...
    #
    # Output
    # Observation-weighted error (OWE). It is negatively oriented and 0 <= OWE.
    # The lower its value, the better the E[Y^2]/E[Y] functional forecast.
    # Each value of the output is the OWE corresponding to the respective value
    # of the vectors x, y.
    #
    # References
